...
public class usuarioDAO {
    ...
    public List<Usuario> getUsuariosSemCr(String cod_cr) {
        String sql = "SELECT usuario.* FROM usuario LEFT JOIN integrante ON username = username_integrante AND cod_cr = ? "
                + "WHERE cod_cr IS NULL AND status_user = 'ativo' AND funcao != 'admin'";
